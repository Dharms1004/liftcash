...
class MasterTransactionHistoryDiamond extends Model implements AuthenticatableContract, AuthorizableContract
{
    protected $table = 'master_transaction_history_diamond';
